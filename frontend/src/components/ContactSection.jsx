          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {[
              ...
              <div key={name}>
                <input
                  ...
                  className={`w-full border-0 border-b border-gray-300 focus:border-[#62a87d] focus:outline-none text-gray-700 py-2 transition-all ${
            ...
            <div>
              <textarea
                ...
                className={`w-full border-0 border-b border-gray-300 focus:border-[#62a87d] focus:outline-none text-gray-700 py-2 resize-none transition-all ${
